...
import ButtonSizeSelect from '../Button/Button-size-select';
import ButtonAddToCart from '../Button/Button-add-to-cart';
import CheckoutModal from '../Checkout/Checkout-modal';
import ButtonsColorSelect from '../Button/Buttons-color-select';
import CarouselItemPage from '../Carousel/Carousel-item';
